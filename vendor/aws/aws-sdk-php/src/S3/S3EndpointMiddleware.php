    ...
    private function applyPathStyleEndpointCustomizations(
        ...
        if ($command->getName() == 'WriteGetObjectResponse') {
            $dnsSuffix = $this->endpointProvider
                ...
                ->getDnsSuffix();
            $fips = \Advanced_Media_Offloader\Vendor\Aws\is_fips_pseudo_region($this->region) ? "-fips" : "";
            $region = \Advanced_Media_Offloader\Vendor\Aws\strip_fips_pseudo_regions($this->region);
            $host =
