<?php
namespace Advanced_Media_Offloader\Vendor\Aws\Endpoint;

use ArrayAccess;
use Advanced_Media_Offloader\Vendor\Aws\HasDataTrait;
use Advanced_Media_Offloader\Vendor\Aws\Sts\RegionalEndpoints\ConfigurationProvider;
use Advanced_Media_Offloader\Vendor\Aws\S3\RegionalEndpoint\ConfigurationProvider as S3ConfigurationProvider;
