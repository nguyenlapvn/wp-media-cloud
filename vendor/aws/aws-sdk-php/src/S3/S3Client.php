...
use Advanced_Media_Offloader\Vendor\Aws\Api\DocModel;
use Advanced_Media_Offloader\Vendor\Aws\Api\Service;
use Advanced_Media_Offloader\Vendor\Aws\AwsClient;
use Advanced_Media_Offloader\Vendor\Aws\CacheInterface;
use Advanced_Media_Offloader\Vendor\Aws\ClientResolver;
use Advanced_Media_Offloader\Vendor\Aws\Command;
...
use Advanced_Media_Offloader\Vendor\Aws\HandlerList;
use Advanced_Media_Offloader\Vendor\Aws\Identity\S3\S3ExpressIdentityProvider;
use Advanced_Media_Offloader\Vendor\Aws\InputValidationMiddleware;
use Advanced_Media_Offloader\Vendor\Aws\Middleware;
use Advanced_Media_Offloader\Vendor\Aws\ResultInterface;
use Advanced_Media_Offloader\Vendor\Aws\Retry\QuotaManager;
use Advanced_Media_Offloader\Vendor\Aws\RetryMiddleware;
use Advanced_Media_Offloader\Vendor\Aws\RetryMiddlewareV2;
use Advanced_Media_Offloader\Vendor\Aws\S3\RegionalEndpoint\ConfigurationProvider;
use Advanced_Media_Offloader\Vendor\Aws\S3\UseArnRegion\Configuration;
use Advanced_Media_Offloader\Vendor\Aws\S3\UseArnRegion\ConfigurationInterface;
use Advanced_Media_Offloader\Vendor\Aws\S3\UseArnRegion\ConfigurationProvider as UseArnRegionConfigurationProvider;
...
class S3Client extends AwsClient implements S3ClientInterface
{
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        $request = \Advanced_Media_Offloader\Vendor\Aws\serialize($command);
     ...
     * use the {@see \Advanced_Media_Offloader\Vendor\Aws\S3\S3Client::createPresignedRequest} method and get
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \Advanced_Media_Offloader\Vendor\Aws\serialize($command)->getUri();
    }
    ...
    {
        if ($value) {
            $config = \Advanced_Media_Offloader\Vendor\Aws\Retry\ConfigurationProvider::unwrap($value);
