...
use Advanced_Media_Offloader\Vendor\Aws\S3\Exception\PermanentRedirectException;
 ...
 * classes implementing \Advanced_Media_Offloader\Vendor\Aws\S3\S3ClientInterface
 */
trait S3ClientTrait
{
    ...
    public function deleteMatchingObjectsAsync(
        ...
        if ($regex) {
            $iter = \Advanced_Media_Offloader\Vendor\Aws\filter($iter, function ($c) use ($regex) {
