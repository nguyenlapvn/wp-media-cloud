<?php
namespace Advanced_Media_Offloader\Vendor\Aws\Api\Serializer;

use Advanced_Media_Offloader\Vendor\Aws\Api\MapShape;
use Advanced_Media_Offloader\Vendor\Aws\Api\Service;
use Advanced_Media_Offloader\Vendor\Aws\Api\Operation;
use Advanced_Media_Offloader\Vendor\Aws\Api\Shape;
use Advanced_Media_Offloader\Vendor\Aws\Api\StructureShape;
use Advanced_Media_Offloader\Vendor\Aws\Api\TimestampShape;
...
use Advanced_Media_Offloader\Vendor\Aws\EndpointV2\EndpointV2SerializerTrait;
use Advanced_Media_Offloader\Vendor\Aws\EndpointV2\Ruleset\RulesetEndpoint;
use GuzzleHttp\Psr7;
