...
use Advanced_Media_Offloader\Vendor\Aws\Exception\InvalidJsonException;
use Advanced_Media_Offloader\Vendor\Aws\Sdk;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = $config['client'] ?? \Advanced_Media_Offloader\Vendor\Aws\default_http_handler();
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \Advanced_Media_Offloader\Vendor\Aws\default_user_agent();
    ...
    {
        $isImdsV1Disabled = \Advanced_Media_Offloader\Vendor\Aws\boolean_value($this->ec2MetadataV1Disabled)
            ?? \Advanced_Media_Offloader\Vendor\Aws\boolean_value(
