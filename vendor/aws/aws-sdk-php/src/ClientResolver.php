...
use Advanced_Media_Offloader\Vendor\Aws\Api\ApiProvider;
use Advanced_Media_Offloader\Vendor\Aws\Api\Service;
use Advanced_Media_Offloader\Vendor\Aws\Api\Validator;
use Advanced_Media_Offloader\Vendor\Aws\Auth\AuthResolver;
use Advanced_Media_Offloader\Vendor\Aws\Auth\AuthSchemeResolver;
use Advanced_Media_Offloader\Vendor\Aws\Auth\AuthSchemeResolverInterface;
use Advanced_Media_Offloader\Vendor\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use Advanced_Media_Offloader\Vendor\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use Advanced_Media_Offloader\Vendor\Aws\ClientSideMonitoring\Configuration;
use Advanced_Media_Offloader\Vendor\Aws\Configuration\ConfigurationResolver;
use Advanced_Media_Offloader\Vendor\Aws\Credentials\CredentialProvider;
use Advanced_Media_Offloader\Vendor\Aws\Credentials\Credentials;
use Advanced_Media_Offloader\Vendor\Aws\Credentials\CredentialsInterface;
use Advanced_Media_Offloader\Vendor\Aws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use Advanced_Media_Offloader\Vendor\Aws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
use Advanced_Media_Offloader\Vendor\Aws\Endpoint\EndpointProvider;
use Advanced_Media_Offloader\Vendor\Aws\Endpoint\PartitionEndpointProvider;
use Advanced_Media_Offloader\Vendor\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use Advanced_Media_Offloader\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use Advanced_Media_Offloader\Vendor\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use Advanced_Media_Offloader\Vendor\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use Advanced_Media_Offloader\Vendor\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use Advanced_Media_Offloader\Vendor\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use Advanced_Media_Offloader\Vendor\Aws\EndpointDiscovery\ConfigurationInterface;
use Advanced_Media_Offloader\Vendor\Aws\EndpointDiscovery\ConfigurationProvider;
use Advanced_Media_Offloader\Vendor\Aws\EndpointV2\EndpointDefinitionProvider;
use Advanced_Media_Offloader\Vendor\Aws\Exception\AwsException;
use Advanced_Media_Offloader\Vendor\Aws\Exception\InvalidRegionException;
use Advanced_Media_Offloader\Vendor\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use Advanced_Media_Offloader\Vendor\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use Advanced_Media_Offloader\Vendor\Aws\Signature\SignatureProvider;
use Advanced_Media_Offloader\Vendor\Aws\Token\Token;
use Advanced_Media_Offloader\Vendor\Aws\Token\TokenInterface;
use Advanced_Media_Offloader\Vendor\Aws\Token\TokenProvider;
...
class ClientResolver
{
    ...
    public static function _apply_endpoint_provider($value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            if ($value instanceof \Advanced_Media_Offloader\Vendor\Aws\EndpointV2\EndpointProviderV2) {
            ...
            $args['region'] = \Advanced_Media_Offloader\Vendor\Aws\strip_fips_pseudo_regions($args['region']);
    ...
    public static function _default_endpoint_provider(array $args)
    {
        ...
        if (self::isValidService($serviceName)
            ...
            return new \Advanced_Media_Offloader\Vendor\Aws\EndpointV2\EndpointProviderV2(
                $ruleset,
    ...
    public static function _default_endpoint(array &$args)
    {
        ...
        $serviceIdentifier = \Advanced_Media_Offloader\Vendor\Aws\manifest($args['service'])['serviceIdentifier'];
...
EOT;
    ...
    private static function isValidService($service) {
        ...
        $services = \Advanced_Media_Offloader\Vendor\Aws\manifest();
