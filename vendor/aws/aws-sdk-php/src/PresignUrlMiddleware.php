...
use Advanced_Media_Offloader\Vendor\Aws\Signature\SignatureV4;
...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(
        ...
        $request = \Advanced_Media_Offloader\Vendor\Aws\serialize($newCmd);
        // Create the new endpoint for the target endpoint.
        if ($this->endpointProvider instanceof \Advanced_Media_Offloader\Vendor\Aws\EndpointV2\EndpointProviderV2) {
