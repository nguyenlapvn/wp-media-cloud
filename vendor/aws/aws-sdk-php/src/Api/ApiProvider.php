<?php
namespace Advanced_Media_Offloader\Vendor\Aws\Api;

use Advanced_Media_Offloader\Vendor\Aws\Exception\UnresolvedApiException;
 ...
 *
 *     $c = \Advanced_Media_Offloader\Vendor\Aws\or_chain($a, $b);
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \Advanced_Media_Offloader\Vendor\Aws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \Advanced_Media_Offloader\Vendor\Aws\load_compiled_json($path);
