...
use Advanced_Media_Offloader\Vendor\Aws\Auth\AuthSelectionMiddleware;
use Advanced_Media_Offloader\Vendor\Aws\Auth\AuthSchemeResolverInterface;
use Advanced_Media_Offloader\Vendor\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use Advanced_Media_Offloader\Vendor\Advanced_Media_Offloader\Vendor\Aws\EndpointV2\EndpointProviderV2;
use Advanced_Media_Offloader\Vendor\Aws\EndpointV2\EndpointV2Middleware;
...
class AwsClient implements AwsClientInterface
{
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \Advanced_Media_Offloader\Vendor\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \Advanced_Media_Offloader\Vendor\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
