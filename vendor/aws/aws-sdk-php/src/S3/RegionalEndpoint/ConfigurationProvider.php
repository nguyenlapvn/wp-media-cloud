<?php
namespace Advanced_Media_Offloader\Vendor\Aws\S3\RegionalEndpoint;
...
use Advanced_Media_Offloader\Vendor\Aws\S3\RegionalEndpoint\Exception\ConfigurationException;
