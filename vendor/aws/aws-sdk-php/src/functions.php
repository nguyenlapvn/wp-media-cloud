 ...
 *     $fn = \Advanced_Media_Offloader\Vendor\Aws\or_chain($a, $b);
 *     echo $fn(1, 2); // 3
 *
 * @return callable
 */
...
function default_http_handler()
{
    ...
    if ($version === 6 || $version === 7) {
        return new \Advanced_Media_Offloader\Vendor\Aws\Handler\GuzzleV6\GuzzleHandler();
    }

    // If Guzzle 5 installed
    if ($version === 5) {
        return new \Advanced_Media_Offloader\Vendor\Aws\Handler\GuzzleV5\GuzzleHandler();
    }
