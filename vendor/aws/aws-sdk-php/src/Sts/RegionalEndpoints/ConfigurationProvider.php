<?php
namespace Advanced_Media_Offloader\Vendor\Aws\Sts\RegionalEndpoints;
...
use Advanced_Media_Offloader\Vendor\Aws\Sts\RegionalEndpoints\Exception\ConfigurationException;
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini(
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \Advanced_Media_Offloader\Vendor\Aws\parse_ini_file($filename, true);
            if ($data === false) {
