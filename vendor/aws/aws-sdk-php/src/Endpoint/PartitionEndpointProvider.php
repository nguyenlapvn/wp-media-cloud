...
class PartitionEndpointProvider
{
    ...
    {
        $data = \Advanced_Media_Offloader\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \Advanced_Media_Offloader\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
