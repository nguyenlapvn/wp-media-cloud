...
namespace Advanced_Media_Offloader\Vendor\Aws\Configuration;
...
class ConfigurationResolver
{
    ...
    {
        if ($type === 'bool'
            && !is_null($convertedValue = \Advanced_Media_Offloader\Vendor\Aws\boolean_value($value))
        ) {
    ...
    private static function retrieveValueFromIniSubsection(
        ...
        $services_section = \Advanced_Media_Offloader\Vendor\Aws\parse_ini_section_with_subsections(
            $filename,
