<?php
namespace Advanced_Media_Offloader\Vendor\Aws\S3Control;
...
use Advanced_Media_Offloader\Vendor\Aws\Arn\S3\BucketArnInterface;
...
use Advanced_Media_Offloader\Vendor\Aws\S3\EndpointRegionHelperTrait;
use GuzzleHttp\Psr7;
