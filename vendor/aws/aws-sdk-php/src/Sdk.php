 ...
 * @method \Advanced_Media_Offloader\Vendor\Aws\S3\S3Client createS3(array $args = [])
...
class Sdk
{
     ...
     * @return string
     * @internal
     * @deprecated Use the `\Advanced_Media_Offloader\Vendor\Aws\manifest()` function instead.
     */
