<?php
namespace Advanced_Media_Offloader\Vendor\Aws\S3\UseArnRegion;

use Advanced_Media_Offloader\Vendor\Aws\AbstractConfigurationProvider;
use Advanced_Media_Offloader\Vendor\Aws\CacheInterface;
use Advanced_Media_Offloader\Vendor\Aws\ConfigurationProviderInterface;
use Advanced_Media_Offloader\Vendor\Aws\S3\UseArnRegion\Exception\ConfigurationException;
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \Advanced_Media_Offloader\Vendor\Aws\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {
