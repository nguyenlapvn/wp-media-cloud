<?php
namespace Advanced_Media_Offloader\Vendor\Aws\EndpointDiscovery;
...
use Advanced_Media_Offloader\Vendor\Aws\EndpointDiscovery\Exception\ConfigurationException;
